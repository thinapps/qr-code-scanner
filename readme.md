...
- explicitly excludes app data from Android cloud backup and device-to-device transfer
...
- updates the release workflow to install the Android 36 platform and generate Gradle `8.11.1`
