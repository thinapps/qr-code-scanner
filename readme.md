...
- does not support Micro QR, rectangular Micro QR, MicroPDF417, MaxiCode, DotCode, postal barcodes, MSI, Plessey, Code 11, Pharmacode, or proprietary color, circular, or app-specific codes
