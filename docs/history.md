...
The history icon in the scanner title row opens the history screen.

The history screen shows saved results in newest-first order. Tapping a saved result returns it to the main scanner screen for preview, copy, open, or share actions.

## Clearing history

The history screen includes a Clear All History button. Clearing history removes the saved local history list only.
